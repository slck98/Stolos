/* INSERT INTO TESTS */
INSERT INTO Driver(FirstName, LastName, Address, BirthDate, NationalRegistrationNumber, DriversLicenses, GascardID, VehicleVIN, Deleted) VALUES ('John', 'Doe', '123 Lexington Av., NYC, NY, USA', '1985-12-31', '85.12.31-123.40', 'AM,B,C1E', NULL, NULL, 0);

INSERT INTO Driver(FirstName, LastName, Address, BirthDate, NationalRegistrationNumber, DriversLicenses, GascardID, VehicleVIN, Deleted) VALUES ('Maarten', 'Smet', 'Sint-Denijs-Westrem', '1980-7-04', '80.07.04-457.85', 'AM,B', NULL, NULL, 0);
INSERT INTO Driver(FirstName, LastName, Address, BirthDate, NationalRegistrationNumber, DriversLicenses, GascardID, VehicleVIN, Deleted) VALUES ('Simon', 'Van Hoecke', 'Hamme', '1995-08-27', '95.08.27-097.77', 'AM,B,C1E,D1E', NULL, NULL, 0);
INSERT INTO Driver(FirstName, LastName, Address, BirthDate, NationalRegistrationNumber, DriversLicenses, GascardID, VehicleVIN, Deleted) VALUES ('Noah', 'De Kraene', 'Oostende', '1972-02-12', '72.02.12-113.83', 'AM,B,C1E', NULL, NULL, 0);
INSERT INTO Driver(FirstName, LastName, Address, BirthDate, NationalRegistrationNumber, DriversLicenses, GascardID, VehicleVIN, Deleted) VALUES ('Thomas', 'De Bruyne', 'Schaarbeek', '1992-01-15', '92.01.15-225.03', 'AM,B', NULL, NULL, 0);
INSERT INTO Driver(FirstName, LastName, Address, BirthDate, NationalRegistrationNumber, DriversLicenses, GascardID, VehicleVIN, Deleted) VALUES ('Wouter', 'Van Breeck', 'Zolder', '1963-09-21', '63.09.21-991.56', 'AM,B', NULL, NULL, 0);
INSERT INTO Driver(FirstName, LastName, Address, BirthDate, NationalRegistrationNumber, DriversLicenses, GascardID, VehicleVIN, Deleted) VALUES ('Alexander', 'Van Haver', 'Haver', '1999-09-09', '99.09.09-099.27', 'AM,B', NULL, NULL, 0);
